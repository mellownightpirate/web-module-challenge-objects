...
console.log(createMenuItem("Prawn and mayo sandwich", 4, "Snack"));
console.log(createMenuItem("tuna and sweetcorn sandwich", 4, "Snack"));
console.log(createMenuItem("Beans", 2, "Lunch"));
